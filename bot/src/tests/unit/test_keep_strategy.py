...
def test_keep_n_of_face_keeps_up_to_n():
  assert _keep_n_of_face([6, 6, 6, 1, 2, 3], 6, 2) == [
    True,
    True,
    False,
    False,
...
def test_keep_n_of_face_fewer_than_n_available():
  assert _keep_n_of_face([6, 1, 2, 3, 4, 5], 6, 3) == [
    True,
    False,
    False,
    False,
...
def test_keep_pairs_from_faces_two_pairs():
  assert _keep_pairs_from_faces([5, 5, 4, 4, 1, 2], [5, 4]) == [
    True,
    True,
    True,
    True,
...
def test_keep_for_straight_no_run():
  assert _keep_for_straight([1, 1, 1, 6, 6, 6]) == [
    False,
    False,
    False,
    False,
